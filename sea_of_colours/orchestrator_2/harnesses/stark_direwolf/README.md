> ### This directory is yours — STARK_DIREWOLF
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/stark_direwolf/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/stark_direwolf/_v7/chat_schema.py
...
Prefer changing `stark_direwolf/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `STARK_DIREWOLF_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `STARK_DIREWOLF_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
