...
What lives here is only what ``stark_direwolf/prompt.py`` still imports:
...
``stark_direwolf/prompt.py``; if you are looking for section order, doctrine
...
from sea_of_colours.orchestrator_2.harnesses.stark_direwolf._v7.validators import (
